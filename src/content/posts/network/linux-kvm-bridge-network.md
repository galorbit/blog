---
title: "Linux KVM 虚拟机桥接网络配置指南"
published: 2026-08-04
description: "本文介绍在 Linux 宿主机上通过 NetworkManager 和 ifcfg 脚本配置 KVM 双网桥隔离网络的详细步骤。"
category: "网络配置"
tags:
  - "KVM"
  - "桥接网络"
...
KVM 图形界面管理器：
- 在硬件配置界面，选择网络。
- 模式选择桥接模式，设备填 `br0` 或者 `br1`，按实际需求更改。
