---
title: "Linux网络配置优化与故障排查指南"
published: 2026-08-04
description: "详解Linux开机网络卡顿修复、cloud-init冲突处理、Netplan静态IP模板及Bonding/LACP聚合配置与故障排查。"
category: "网络配置"
tags:
  - "Netplan"
  - "systemd"
...
`systemd-networkd-wait-online.service` 默认等待所有网络接口上线，超时时间长达 120 秒，若接口未连接或配置错误会导致开机卡顿。
