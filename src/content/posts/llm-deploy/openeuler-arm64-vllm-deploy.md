---
title: "openEuler ARM64 部署 VLLM 大模型推理服务指南"
published: 2026-08-04
description: "本文详细记录了在 openEuler ARM64 架构服务器上，从零搭建 CUDA 12.6 环境并源码编译部署 VLLM 大模型推理服务的完整流程。"
category: "大模型部署"
tags:
  - "openEuler"
  - "VLLM"
...
# openEuler ARM64 部署 VLLM 大模型推理服务指南
...
```bash
sudo yum install -y gcc g++ cmake ninja-build numactl-devel git zlib-devel
```
