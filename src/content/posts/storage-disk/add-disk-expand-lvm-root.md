---
title: "Ubuntu添加新硬盘并在线扩容LVM根分区"
published: 2026-08-04
description: "介绍在Ubuntu系统中添加新硬盘，并通过LVM技术在不重启的情况下在线扩容根分区的完整操作步骤。"
category: "存储与磁盘"
tags:
  - "LVM"
  - "Ubuntu"
...
Size of logical volume ubuntu-vg/ubuntu-lv changed from <927.95 GiB (237554 extents) to <2.73 TiB (714485 extents).
Logical volume ubuntu-vg/ubuntu-lv successfully resized.
```

扩容完成后空间还是用不了，需要刷新逻辑卷容量。根据文件系统类型选择对应命令：ext4 使用 `resize2fs`，xfs 使用 `xfs_growfs`。
