---
title: "PMC芯片存储控制器管理命令arcconf使用指南"
published: 2026-08-04
description: "整理PMC芯片存储控制器的arcconf管理命令参考，包含常用配置示例及完整命令列表说明。"
category: "存储与磁盘"
tags:
  - "arcconf"
  - "RAID控制器"
...
PHYERRORLOG 显示控制器或设备或expander PHY的PHY error日志
...
SETPERFORM 根据应用变更适配器设置
SETPHY 重配置PHY设置
SETPOWER 设置控制器或逻辑设备功耗
SETPRIORITY 改变特定的或全局的任务优先级
SETSTATSDATACOLLECTION 打开控制器统计数据收集模式
SLOTCONFIG 列出背板上的每个槽位的设备
