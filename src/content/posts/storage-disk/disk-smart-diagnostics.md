---
title: "磁盘信息查看与 SMART 诊断指南"
published: 2026-08-04
description: "详解 smartctl 命令用法、SSD/HDD 核心参数解读、自检操作及企业级盘读写量换算示例。"
category: "存储与磁盘"
tags:
  - "smartctl"
  - "SMART"
...
> **重要**：企业级 SSD（如 Solidigm/Intel）的 `Total_LBAs_Written` / `Total_LBAs_Read` RAW_VALUE 使用的单位与消费级 SSD 不同，**不能按 `RAW × 512B` 计算**。
>
...
| 累计写入量 (ID 241) | 1623 GiB (~1.58 TiB) | 使用量低 |
| 累计读取量 (ID 242) | 2197 GiB (~2.15 TiB) | 使用量低 |
| 温度 (ID 194) | 33°C | 正常 |
