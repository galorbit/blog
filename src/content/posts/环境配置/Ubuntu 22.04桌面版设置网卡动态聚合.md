...
tags:
  ...
  - 网卡聚合
  - 网络
slug: ubuntu-2204-desktop-nic-bonding
---
...
> 桌面版默认使用NetworkManager管理网络，需要禁用NetworkManager,使用systemd-netwokd来管理网络。注意，禁用NetworkManager后，图形界面的网络管理会失效，需要使用命令行来配置网络。
...
`sudo apt install ifenslave -y` 安装ifenslave
